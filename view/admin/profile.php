<?php  
    ...
    $image = $row['image'] == NULL ? "../../assets/img/icons/open.png" : "../../assets/img/admin_img/".$row['image'];
...
?>
    ...
    <div id="tabs" class="tab-content">
      <div id="tab1" class="tab-pane <?php echo $firstActive ?>">
        ...
        <div class="row">
          <form action="change_admin_img.php" method="POST" enctype="multipart/form-data">
            ...
            <a id="changeLink">Change Picture</a>
        ...
        <div id="tab2" class="tab-pane <?php echo $active; ?>">
          ...
          <?php if(isset($_GET['notUp'])){ echo '<div class="imgErr" style="display:block; margin: 5px 20px;">Record is not updated</div>'; } ?>
            <form class="form-horizontal" action="change_admin_info.php" method="POST">
              <!-- First Name -->
              <div class="form-group">
                ...
                <!-- Gender -->
                  <div class="form-group">
                    ...
                    <div class="col-sm-12">
                      <input type="radio" class="gender" name="gender" value="Male" <?php if($gender == 'Male'){echo 'checked';} ?>>Male 
                      <input type="radio" class="gender" name="gender" value="Femle" <?php if($gender == 'Female'){echo 'checked';} ?>>Female
                    </div>
                  </div>
            ...
            <div id="tab3" class="tab-pane <?php echo $active2 ?>">
                ...
                <?php if(isset($_GET['password'])){ echo '<div class="imgErr" style="display:block; margin: 5px 20px;">Please type password correctly!</div>'; } ?>
                    <form class="form-horizontal" action="change_admin_password.php" method="POST">
                    <!-- current pass -->
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <?php if(isset($_GET['addressDone'])){ echo '<div class="success" style="display:block; margin: 5px 20px;">Address successfully updated!</div>'; } ?>
                        <div style="padding: 0px 20px;">
                          <form action="change_admin_address.php" method="POST">
