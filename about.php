      ...
      <div class="container">
         ...
         <div class="row">
            <div class="col-lg-6 col-md-6">
               <div class="about_img">
                  <img src="assets/img/blog_img/about.png" alt="">
               </div>
            </div>
               ...
               <div class="grid">
                  ...
                  <div class="grid-item big_weight">
                     <div class="project_img">
                        <img src="assets/img/blog_img/gallery/gallery_1.png" alt="">
                  ...
                  <div class="grid-item big_height">
                     <div class="project_img">
                        <img src="assets/img/blog_img/gallery/gallery_4.png" alt="">
                        <div class="project_gallery_hover_text">
                           <p>Home Apartment</p>
                           <h3>Detached House For Sale </h3>
                           <ul>
                  ...
                  <div class="grid-item">
                     <div class="project_img">
                        <img src="assets/img/blog_img/gallery/gallery_2.png" alt="">
                        <div class="project_gallery_hover_text">
                           <p>Home Apartment</p>
                           <h3>Detached House For Sale </h3>
                           <ul>
                  ...
                  <div class="grid-item">
                     <div class="project_img">
                        <img src="assets/img/blog_img/gallery/gallery_3.png" alt="">
                        <div class="project_gallery_hover_text">
                           <p>Home Apartment</p>
                           <h3>Detached House For Sale </h3>
                           <ul>
                ...
                <div class="col-lg-11 col-sm-8">
                    ...
                    <div class="slider-nav-thumbnails">
                        <div class="slider-thumbnails">
                            <img src="assets/img/blog_img/client/client_1.png" alt="slideimg" class="image">
                            <div data-index="1">
                        ...
                        <div class="slider-thumbnails">
                            <img src="assets/img/blog_img/client/client_2.png" alt="slideimg" class="image">
                            <div data-index="2">
                                <div class="client_review_text text-center">
                                    <h3>Daniel E Gilcritst</h3>
                                    <h5>Manager, Vision</h5>
                        ...
                        <div class="slider-thumbnails">
                            <img src="assets/img/blog_img/client/client_3.png" alt="slideimg" class="image">
                            <div data-index="3">
                                <div class="client_review_text text-center">
                                    <h3>Daniel E Gilcritst</h3>
                                    <h5>Manager, Vision</h5>
